...
Standardize, minimize, and easily manage workflow execution code within and across development teams. Ease the learning curve for developers new to Durable Functions. Microflow can be seen a "low-code" or even a "no-code" app if code is not used to create the JSON workflows.
