...
{
    public static class SharedTableHelper
    {
        #region Formatting
        ...
        public static async Task<string> GetWorkflowJson(string workflowName)
        {
            ...
            MicroflowModels.Microflow proj = JsonSerializer.Deserialize<Microflow>(projConfig.Config);
        ...
        {
            TableClient tableClient = TableHelpers.GetStepsTable();
        ...
        public static async Task CreateTables()
        {
            ...
            // Error table
            TableClient errorsTable = TableHelpers.GetErrorsTable();
