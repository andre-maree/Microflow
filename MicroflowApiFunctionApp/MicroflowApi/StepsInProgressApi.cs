...
namespace MicroflowApi
{
    public class StepsInProgressApi
    {
        ...
        public static async Task<int> GetStepsCountInProgress([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "microflowApi/" + MicroflowVersion + "/GetStepsCountInProgress/{workflowNameStepNumber}")] HttpRequestMessage req,
